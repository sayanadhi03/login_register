    ...
    <div className="w-full min-h-screen flex justify-center items-center bg-blue-200 p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-2xl p-8">
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-linear-to-r from-blue-500 to-purple-600 text-white font-semibold py-3 px-4 rounded-lg hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform hover:scale-105 transition duration-200 shadow-lg"
          >
            Create Account
          </button>
